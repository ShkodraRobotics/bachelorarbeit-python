...
class nootebook_frame(tk.Frame):
    ...
    def widget(self):
        ...
        # Hier wird das Video Signal übergeben 0 Integrierte Webcam
        def frame_():
        ...
        def video(num_sorce):
            try:
                global cap
                self.num_sorce = int(self.num_sorce)

                self.cap = cv2.VideoCapture(self.num_sorce)
